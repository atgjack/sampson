...
export { choose, error, factorial, gamma, gammainc_lower, lngamma, median, mean, mode, percentile, quantile, range, select, std, stirling, sum, sumNthPowerDev, variance, zscore, Normal, Binomial, Bernoulli, StudentsT, Gamma, ChiSquared, Exponential, Cauchy, Sample, ttest };